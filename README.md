...
- Change socket.IO endpoint on client side. To do this, go to `client/src/components/Game.js` and change line #26 from `const ENDPOINT = 'Will later give link'` to `const ENDPOINT = 'http://localhost:5000'`
